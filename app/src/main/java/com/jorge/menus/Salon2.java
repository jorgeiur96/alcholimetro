...
public class Salon2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.salon2);
    ...
    public void obtDatos(){
        ...
        String url="https://serox.000webhostapp.com/horarios2.php";
        RequestParams parametros2 =new RequestParams();
       parametros2.put("id_salon2",numero+1);
    ...
    public ArrayList<String> obtDatos (String response){
        ...
        try {
            ...
            for (int i=0;i<jsonArray.length();i++){
                ...
                texto6 =jsonArray.getJSONObject(i).getString("savado");
